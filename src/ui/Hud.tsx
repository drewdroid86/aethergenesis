        ...
        <>
            ...
            <div className="absolute bottom-0 w-full p-8 flex justify-between items-end z-20 pointer-events-none">
                ...
                <div className="absolute left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 w-1/3 pointer-events-auto">
                    <div className="w-full px-8 py-4 bg-[rgba(8,8,20,0.6)] backdrop-blur-2xl border border-[rgba(126,184,255,0.2)] rounded-2xl flex flex-col items-center group focus-within:ring-0">
                        ...
                        <div 
                            ...
                            className="w-full h-3 bg-white/10 rounded-full overflow-hidden cursor-ew-resize relative group focus-visible:ring-2 focus-visible:ring-[#C084FC] outline-none"
                        ...
                        >
                            ...
                            <div className="absolute inset-0 bg-white/20 opacity-0 group-hover:opacity-100 group-focus-visible:opacity-100 transition-opacity"></div>
                        </div>
