        ...
        <div className="flex items-center gap-8 bg-[rgba(8,8,20,0.6)] backdrop-blur-md border border-[rgba(126,184,255,0.2)] rounded-full px-6 py-3">
          <div className="flex flex-col items-center">
            ...
            <span className="font-mono text-sm">
              {performance.numStars.toLocaleString()} <span className="text-[#C084FC]">★</span>
            </span>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <span className="font-mono text-sm uppercase text-indigo-300">
          ...
          <div className="flex flex-col items-center">
            ...
            <span className="font-mono text-sm">
              {performance.fps} <span className="text-[10px] opacity-50">FPS</span>
            </span>
          </div>
        </div>
      </nav>
      ...
      <div className="absolute bottom-0 w-full p-8 flex justify-between items-end z-20 pointer-events-none">
        <div className="font-mono text-[10px] text-[#7EB8FF]/60 space-y-1 border-l border-[#C084FC]/50 pl-4 bg-[rgba(8,8,20,0.4)] backdrop-blur-md py-3 pr-4 rounded-r border-y-0 border-r-0 pointer-events-auto group/telemetry">
          ...
          <div className="text-white">
            <span className="text-[#7EB8FF]/70 mr-2">POS_X:</span>
            <span ref={uiRefs.hudX}>0.0000</span>
          </div>
          <div className="text-white">
            <span className="text-[#7EB8FF]/70 mr-2">POS_Y:</span>
            <span ref={uiRefs.hudY}>0.0000</span>
          </div>
          <div className="text-white">
            <span className="text-[#7EB8FF]/70 mr-2">POS_Z:</span>
        ...
        <div className="absolute left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 w-1/3 pointer-events-auto">
          <div className="w-full px-8 py-4 bg-[rgba(8,8,20,0.6)] backdrop-blur-2xl border border-[rgba(126,184,255,0.2)] rounded-2xl flex flex-col items-center group">
            <div className="flex justify-between w-full items-center mb-3">
              <span className="text-[9px] uppercase tracking-widest text-[#7EB8FF]">
                Global Cosmic Age (Gyr){' '}
                <span className="opacity-0 group-hover:opacity-100 transition-opacity ml-2 text-[8px] text-[#C084FC] hidden sm:inline">
                  [Arrows to Seek]
                </span>
              </span>
              <div className="flex gap-2">
                ...
                <button
                  ...
                  aria-label={
                    isPlayingCosmic ? 'Pause cosmic simulation' : 'Play cosmic simulation'
                  }
            ...
            >
              <div
                ref={uiRefs.globalTimelineFill}
                className="h-full bg-gradient-to-r from-[#7EB8FF] to-[#C084FC]"
                style={{ width: `${(cosmicAge / 14.0) * 100}%` }}
              ></div>
              <div className="absolute inset-0 bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity"></div>
            </div>
            <span className="font-mono text-2xl font-light tracking-wider mt-2" ref={uiRefs.hudAge}>
              {cosmicAge.toFixed(2)}
            </span>
          </div>
          <p className="text-[10px] text-[#7EB8FF]/50 italic text-center pointer-events-none">
            "Scrub to T=0 to observe pre-stellar plasma state."
          </p>
        </div>
        ...
        <div className="flex flex-col items-end gap-2 text-right">
          ...
          <span className="text-[9px] uppercase tracking-widest text-[#7EB8FF]/60 mt-1">
            Stellar Raycasting Active
          </span>
        </div>
      </div>
    </>
