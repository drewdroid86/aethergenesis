        ...
        <>
            ...
            <nav className="absolute top-0 w-full p-4 md:p-8 flex justify-between items-start z-20 pointer-events-none">
                ...
                <div className="flex flex-col items-center">
                    ...
                    >
                        <span className={`absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] text-[#C084FC] transition-opacity whitespace-nowrap ${idCopied ? 'opacity-100' : 'opacity-0 group-hover/uid:opacity-100 group-focus-within/uid:opacity-100'}`}>
            ...
            <div className="absolute bottom-0 w-full p-8 flex justify-between items-end z-20 pointer-events-none">
                ...
                <div className="flex items-center justify-between gap-4 mb-2 pb-1 border-b border-[rgba(126,184,255,0.2)]">
                    ...
                    >
                        <span className={`absolute -top-6 right-0 text-[10px] text-[#C084FC] transition-opacity whitespace-nowrap ${copied ? 'opacity-100' : 'opacity-0 group-hover/copy:opacity-100 group-focus-within/copy:opacity-100'}`}>
                            {copied ? 'Copied!' : 'Copy'}
                        </span>
                ...
                <div className="absolute left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 w-1/3 pointer-events-auto">
                    <div className="w-full px-8 py-4 bg-[rgba(8,8,20,0.6)] backdrop-blur-2xl border border-[rgba(126,184,255,0.2)] rounded-2xl flex flex-col items-center group" tabIndex={-1}>
                        <div className="flex justify-between w-full items-center mb-3">
                            ...
                            <div className="flex gap-2">
                                ...
                                >
                                    <span className="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] text-[#C084FC] opacity-0 group-hover/play:opacity-100 group-focus-within/play:opacity-100 transition-opacity whitespace-nowrap">
                                        [Space]
                                    </span>
                ...
                <div className="grid grid-cols-2 gap-2 pointer-events-auto">
                    ...
                    >
                    <span className="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] text-[#C084FC] opacity-0 group-hover/focus:opacity-100 group-focus-within/focus:opacity-100 transition-opacity whitespace-nowrap">
                        [F] Focus
                    </span>
