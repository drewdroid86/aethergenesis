                    ...
                    <div className="w-full px-8 py-4 bg-[rgba(8,8,20,0.6)] backdrop-blur-2xl border border-[rgba(126,184,255,0.2)] rounded-2xl flex flex-col items-center group">
                        <div className="flex justify-between w-full items-center mb-3">
                            ...
                            <div className="flex gap-2">
                                ...
                                >
                                    <span className="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] text-[#C084FC] opacity-0 group-hover/timescale:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
                                        [T] Scale
                                    </span>
                                    <button 
