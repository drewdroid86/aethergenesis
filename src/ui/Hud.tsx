        ...
        <>
            ...
            <nav className="absolute top-0 w-full p-4 md:p-8 flex justify-between items-start z-20 pointer-events-none">
                ...
                <div className="flex flex-col items-center">
                    ...
                    >
                        <span className={`absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] text-[#C084FC] transition-opacity whitespace-nowrap ${idCopied ? 'opacity-100' : 'opacity-0 group-hover/uid:opacity-100 group-focus-visible/uid:opacity-100 group-focus-within/uid:opacity-100'}`}>
            ...
            <div className="absolute bottom-0 w-full p-8 flex justify-between items-end z-20 pointer-events-none">
                ...
                <div className="absolute left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 w-1/3 pointer-events-auto">
                    <div className="w-full px-8 py-4 bg-[rgba(8,8,20,0.6)] backdrop-blur-2xl border border-[rgba(126,184,255,0.2)] rounded-2xl flex flex-col items-center group/global">
                        <div className="flex justify-between w-full items-center mb-3">
                            <span className="text-[9px] uppercase tracking-widest text-[#7EB8FF]">
                                Global Cosmic Age (Gyr) <span className="opacity-0 group-hover/global:opacity-100 group-focus-within/global:opacity-100 transition-opacity ml-2 text-[8px] text-[#C084FC] hidden sm:inline">[Arrows to Seek]</span>
                            </span>
                            <div className="flex gap-2">
                                ...
                                >
                                    <span className="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] text-[#C084FC] opacity-0 group-hover/timescale:opacity-100 group-focus-visible/timescale:opacity-100 group-focus-within/timescale:opacity-100 transition-opacity whitespace-nowrap">
                                        [T] Scale
                                    </span>
                                    <button 
                                ...
                                >
                                    <span className="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] text-[#C084FC] opacity-0 group-hover/play:opacity-100 group-focus-visible/play:opacity-100 group-focus-within/play:opacity-100 transition-opacity whitespace-nowrap">
                                        [Space]
                                    </span>
                ...
                <div className="grid grid-cols-2 gap-2 pointer-events-auto">
                    ...
                    >
                    <span className="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] text-[#C084FC] opacity-0 group-hover/reset:opacity-100 group-focus-visible/reset:opacity-100 group-focus-within/reset:opacity-100 transition-opacity whitespace-nowrap">
                        [R] Reset
                    </span>
                    ...
                    >
                    <span className="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] text-[#C084FC] opacity-0 group-hover/focus:opacity-100 group-focus-visible/focus:opacity-100 group-focus-within/focus:opacity-100 transition-opacity whitespace-nowrap">
                        [F] Focus
                    </span>
