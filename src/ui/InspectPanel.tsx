    ...
    <div className="absolute right-8 top-1/2 -translate-y-1/2 w-[min(320px,85vw)] overflow-hidden bg-[rgba(14,14,28,0.7)] backdrop-blur-xl border border-[rgba(126,184,255,0.3)] rounded-2xl p-6 z-30 shadow-[0_0_30px_rgba(0,0,0,0.5)] transform transition-all pointer-events-auto">
      ...
      <div className="space-y-4 font-mono text-xs">
        <div className="flex justify-between items-center">
          ...
          <span ref={uiRefs.phase} className="text-[#C084FC] font-bold text-right">
            -
          </span>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-[rgba(126,184,255,0.1)] group/timeline">
          <div className="flex justify-between items-center mb-3">
            <span className="text-[10px] text-[#7EB8FF]/50 uppercase tracking-widest">
              Time Override{' '}
              <span className="opacity-0 group-hover/timeline:opacity-100 transition-opacity ml-1 text-[8px] text-[#C084FC] hidden sm:inline">
                [Arrows to Seek]
              </span>
            </span>
          ...
          >
            <div
              ref={uiRefs.timelineFill}
              className="h-full bg-gradient-to-r from-blue-500 via-fuchsia-500 to-red-500"
              style={{ width: '0%' }}
            ></div>
            ...
            {geminiData && (
              ...
              >
                <div className="text-white">
                  <span className="text-[#7EB8FF]/70">Planet:</span> {geminiData.planet_name}
                </div>
                <div className="text-white">
                  <span className="text-[#7EB8FF]/70">Biome:</span> {geminiData.biome}
                </div>
                <div className="text-white">
                  <span className="text-[#7EB8FF]/70">Species:</span> {geminiData.dominant_species}{' '}
                  (Stage {geminiData.life_stage})
                </div>
                <div className="text-white">
                  <span className="text-[#7EB8FF]/70">Civilization:</span> {geminiData.civilization}
                </div>
                {analysisFailed && (
