                ...
                <div className="mt-8 pt-6 border-t border-[rgba(126,184,255,0.1)] group/timeline">
                    <div className="flex justify-between items-center mb-3">
                        ...
                        <div className="flex gap-2">
                            ...
                            >
                                <span className="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] text-[#C084FC] opacity-0 group-hover/pause:opacity-100 group-focus-visible/pause:opacity-100 group-focus-within/pause:opacity-100 transition-opacity whitespace-nowrap">
                                    [P]
                                </span>
