            ...
            <div className="space-y-4 text-xs font-mono max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
                ...
                <div>
                    ...
                    <input
                        ...
                        className="w-full accent-[#C084FC] cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C084FC] focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 rounded-lg transition-shadow duration-200"
                    />
